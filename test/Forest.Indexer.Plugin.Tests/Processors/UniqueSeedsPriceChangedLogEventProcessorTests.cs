...
public class UniqueSeedsPriceChangedLogEventProcessorTests : ForestIndexerPluginTestBase
{
    ...
    public UniqueSeedsPriceChangedLogEventProcessorTests()
    {
        _uniqueSeedPriceIndexRepository =
            GetRequiredService<IAElfIndexerClientEntityRepository<UniqueSeedPriceIndex, LogEventInfo>>();
    }
    ...
    {
        var uniqueSeedsPriceChangedLogEventProcessor = GetRequiredService<UniqueSeedsPriceChangedLogEventProcessor>();
        ...
        var uniqueSeedsExternalPriceChanged = new UniqueSeedsExternalPriceChanged
        {
        ...
        var logEventInfo = LogEventHelper.ConvertAElfLogEventToLogEventInfo(uniqueSeedsExternalPriceChanged.ToLogEvent());
        ...
        await uniqueSeedsPriceChangedLogEventProcessor.HandleEventAsync(logEventInfo, logEventContext);
        ...
        var tsmSeedPriceList =
            await _uniqueSeedPriceIndexRepository.GetListAsync();
        tsmSeedPriceList.Item1.ShouldBe(2);
        tsmSeedPriceList.Item2[0].SymbolLength.ShouldBe(uniqueSeedsExternalPriceChanged.FtPriceList.Value[0].SymbolLength);
        tsmSeedPriceList.Item2[0].TokenPrice.Symbol.ShouldBe(uniqueSeedsExternalPriceChanged.FtPriceList.Value[0].Symbol);
        tsmSeedPriceList.Item2[0].TokenPrice.Amount.ShouldBe(uniqueSeedsExternalPriceChanged.FtPriceList.Value[0].Amount);
