...
public class
    ProxyAccountManagementAddressAddedLogEventProcessor : AElfLogEventProcessorBase<ProxyAccountManagementAddressAdded,
        LogEventInfo>
{
    ...
    public ProxyAccountManagementAddressAddedLogEventProcessor(
        ILogger<AElfLogEventProcessorBase<ProxyAccountManagementAddressAdded, LogEventInfo>> logger,
    ...
    protected override async Task HandleEventAsync(ProxyAccountManagementAddressAdded eventValue, LogEventContext
        context)
    {
